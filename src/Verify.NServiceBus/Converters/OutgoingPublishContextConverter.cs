class OutgoingPublishContextConverter :
    WriteOnlyJsonConverter<TestableOutgoingPublishContext>
{
    public override void Write(VerifyJsonWriter writer, TestableOutgoingPublishContext context)
    {
